...
const Crousal = () => {
  ...
  const GotoThatPage = () =>{
    ...
    history.replace("/HowToApplyy");
  }
 
  const chnagePage = () => {
    history.replace("/VerifyLicense");
  }

  const ChnagePage = () =>{
    history.replace("/DemoTest");
  }
    return (
    <>
        ...
        <Carousel className="crousal-style" style={{height : '500px'}} >
          ...
          <Carousel.Item interval={2000} >
            ...
            <Carousel.Caption >
              ...
              <Button variant="contained" color="secondary" onClick={chnagePage} style={{padding: '10px 30px '}}>VERIFY LICENSE</Button>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item interval={2000}>
            <img
            ...
            <Carousel.Caption >
              ...
              <Button variant="contained" color="secondary" onClick={ChnagePage} style={{padding: '10px 30px '}} >
                  DEMO TEST
              </Button>
            </Carousel.Caption>
          </Carousel.Item>
